...
async function analizarConGemini(dataUrl: string) {
  ...
  const prompt = `Eres un barbero moderno de tendencias 2026. Recomienda 3 cortes ACTUALES muy DIFERENTES entre sí: el #1 debe ser CORTO (Buzz Cut o Crew Cut, casi rapado), el #2 MEDIO con FLEQUILLO HACIA DELANTE (Edgar, French Crop, Fringe), el #3 con TEXTURA HACIA UN LADO (Side Part, Comb Over, Textured Side). Nada de pelo hacia atrás en los tres. Responde SOLO con JSON válido sin markdown.
{"forma":"Nombre forma cara (Ovalada/Redonda/Cuadrada/Rectangular/Corazón/Diamante/Triangular)","emoji":"emoji representativo","descripcion":"1-2 frases motivadoras","cortes":[{"nombre":"Corte 1 - CORTO","promptIngles":"This is a photo editing task. ONLY edit the hair on top of the head. Replace ONLY the hair with a very short uniform buzz cut, 3-6mm length, no fade. PRESERVE EVERYTHING ELSE EXACTLY: the face must remain completely clean-shaven with smooth bare skin, no beard, no mustache, no goatee, no stubble, no facial hair of any kind. Do not modify the jawline, chin, cheeks, or any facial feature. Same skin, same age, same eyes, same lighting, same background, same clothes. Only the hairstyle changes.","descripcion":"descripción"},{"nombre":"Corte 2 - FLEQUILLO","promptIngles":"This is a photo editing task. ONLY edit the hair on top of the head. Replace ONLY the hair with a French Crop / Edgar style: short textured fringe of 2-3cm falling forward over the forehead, faded sides. PRESERVE EVERYTHING ELSE EXACTLY: the face must remain completely clean-shaven with smooth bare skin, no beard, no mustache, no goatee, no stubble, no facial hair of any kind. Do not modify the jawline, chin, cheeks, or any facial feature. Same skin, same age, same eyes, same lighting, same background, same clothes. Only the hairstyle changes.","descripcion":"descripción"},{"nombre":"Corte 3 - LATERAL","promptIngles":"This is a photo editing task. ONLY edit the hair on top of the head. Replace ONLY the hair with a textured side part / comb over: hair styled to one side with natural texture, length 4-5cm on top, faded sides. PRESERVE EVERYTHING ELSE EXACTLY: the face must remain completely clean-shaven with smooth bare skin, no beard, no mustache, no goatee, no stubble, no facial hair of any kind. Do not modify the jawline, chin, cheeks, or any facial feature. Same skin, same age, same eyes, same lighting, same background, same clothes. Only the hairstyle changes.","descripcion":"descripción"}]}`
