...
"Strict hair-only edit. The person in this photo has a COMPLETELY CLEAN-SHAVEN smooth face with NO facial hair at all — keep it EXACTLY like that. Replace ONLY the hair on top of the head with a [DETALLE — describe specifically: buzz cut OR crew cut, hair length 3-8mm uniform on top, fade type on sides]. Hair must be VERY SHORT and lie flat on the scalp — no fringe, no volume, no styling. Keep EXACT same hair color. ABSOLUTELY DO NOT add any beard, mustache, goatee, stubble, sideburns or facial shadow — the chin, cheeks, jawline and upper lip must remain perfectly smooth and bare, exactly like in the original photo. Identical eyebrows (do not thicken or darken them), identical eyes, nose, lips, jawline, chin, ears, skin tone, skin texture, age, expression. No glow, no beauty filter, no skin smoothing, no HDR. Preserve EXACT same framing, composition, zoom and crop — do not zoom in, do not recrop, keep the same body and shoulders visible. Same lighting, exposure, contrast, background, clothes."

Para CORTE 2 (CREW CUT TEXTURIZADO) usa esta plantilla:
"Strict hair-only edit. The person in this photo has a COMPLETELY CLEAN-SHAVEN smooth face with NO facial hair at all — keep it EXACTLY like that. Replace ONLY the hair on top of the head with a [DETALLE — describe specifically: short textured crew cut, hair length 1-2cm on top with natural messy texture, slightly pushed forward in a SUBTLE way, sides with mid fade]. The top must be VERY SHORT (1-2cm max), NOT a fringe covering the forehead, NOT a bowl cut, NOT a mushroom shape. Forehead visible. Keep EXACT same hair color. ABSOLUTELY DO NOT add any beard, mustache, goatee, stubble, sideburns or facial shadow — the chin, cheeks, jawline and upper lip must remain perfectly smooth and bare, exactly like in the original photo. Identical eyebrows (do not thicken or darken them), identical eyes, nose, lips, jawline, chin, ears, skin tone, skin texture, age, expression. No glow, no beauty filter, no skin smoothing, no HDR. Preserve EXACT same framing, composition, zoom and crop — do not zoom in, do not recrop, keep the same body and shoulders visible. Same lighting, exposure, contrast, background, clothes."

Para CORTE 3 (SIDE PART CLÁSICO ELEGANTE) usa esta plantilla:
"Strict hair-only edit. The person in this photo has a COMPLETELY CLEAN-SHAVEN smooth face with NO facial hair at all — keep it EXACTLY like that. Replace ONLY the hair on top of the head with a [DETALLE — describe specifically: classic modern side part haircut, hair length 4-5cm on top combed cleanly to one side with a defined side parting line, polished elegant look, sides with mid fade]. Style refined like a well-dressed young professional. NO huge volume, NO pompadour, NO Elvis-style quiff, no dramatic puff. Forehead clearly visible. Keep EXACT same hair color. ABSOLUTELY DO NOT add any beard, mustache, goatee, stubble, sideburns or facial shadow — the chin, cheeks, jawline and upper lip must remain perfectly smooth and bare, exactly like in the original photo. Identical eyebrows (do not thicken or darken them), identical eyes, nose, lips, jawline, chin, ears, skin tone, skin texture, age, expression. No glow, no beauty filter, no skin smoothing, no HDR. Preserve EXACT same framing, composition, zoom and crop — do not zoom in, do not recrop, keep the same body and shoulders visible. Same lighting, exposure, contrast, background, clothes."
