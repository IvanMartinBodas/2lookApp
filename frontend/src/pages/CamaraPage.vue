...
{"forma":"Nombre forma cara (Ovalada/Redonda/Cuadrada/Rectangular/Corazón/Diamante/Triangular)","emoji":"emoji representativo","descripcion":"1-2 frases motivadoras","cortes":[{"nombre":"Corte 1 - CORTO","promptIngles":"Replace the hair with a very short buzz cut, hair length 3-6mm, uniform short hair, no fade. CRITICAL: keep face 100% identical, same clean shaved face, NO BEARD, NO MUSTACHE, NO STUBBLE, no facial hair, same skin tone, same age, same expression, same eyes, same lighting, same background, same clothes.","descripcion":"descripción"},{"nombre":"Corte 2 - FLEQUILLO","promptIngles":"Replace the hair with a French Crop / Edgar style: short textured fringe falling forward over the forehead, faded sides, hair 2-3cm on top. CRITICAL: keep face 100% identical, NO BEARD, NO MUSTACHE, NO STUBBLE, no facial hair, same skin tone, same age, same expression, same eyes, same lighting, same background, same clothes.","descripcion":"descripción"},{"nombre":"Corte 3 - LATERAL","promptIngles":"Replace the hair with a textured side part / comb over: hair styled to one side with natural texture, length 4-5cm on top, faded sides. CRITICAL: keep face 100% identical, NO BEARD, NO MUSTACHE, NO STUBBLE, no facial hair, same skin tone, same age, same expression, same eyes, same lighting, same background, same clothes.","descripcion":"descripción"}]}`
