...
async function analizarConGemini(dataUrl: string) {
  ...
  const prompt = `Eres un barbero profesional. Mirando la foto, recomienda 3 cortes modernos para hombre joven (España 2026), realistas y DIFERENTES entre sí. Responde SOLO con JSON válido sin markdown:

{"forma":"Ovalada/Redonda/Cuadrada/Rectangular/Corazón/Diamante/Triangular","emoji":"emoji","descripcion":"1-2 frases motivadoras","cortes":[
  {"nombre":"nombre del corte en español","promptIngles":"...","descripcion":"1-2 frases por qué le favorece"},
  {"nombre":"corte 2","promptIngles":"...","descripcion":"..."},
  {"nombre":"corte 3","promptIngles":"...","descripcion":"..."}
]}
...
- Corte 2: CREW CUT TEXTURIZADO (1-2cm arriba con textura, fade lateral).
- Corte 3: SIDE PART CLÁSICO (4-5cm arriba peinado de lado, raya marcada, fade lateral).`
