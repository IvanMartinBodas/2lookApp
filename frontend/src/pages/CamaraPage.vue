...
CORTE 3 → SIDE PART CLÁSICO MODERNO ELEGANTE: pelo 4-5cm arriba peinado de un lado con raya lateral marcada, look elegante y formal, lados con mid fade. Estilo refinado tipo ejecutivo joven. NO volumen exagerado, NO pompadour, NO Elvis.
...
"Strict hair-only edit. The person in this photo has a COMPLETELY CLEAN-SHAVEN smooth face with NO facial hair at all — keep it EXACTLY like that. Replace ONLY the hair on top of the head with a [DETALLE — describe specifically: buzz cut OR crew cut, hair length 3-8mm uniform on top, fade type on sides]. Hair must be VERY SHORT and lie flat on the scalp — no fringe, no volume, no styling. Keep EXACT same hair color. ABSOLUTELY DO NOT add any beard, mustache, goatee, stubble, sideburns or facial shadow — the chin, cheeks, jawline and upper lip must remain perfectly smooth and bare, exactly like in the original photo. CRITICAL: DO NOT TOUCH ANY PART OF THE FACE. The face must be copied PIXEL BY PIXEL from the original photo without any modification whatsoever. Do not retouch, redraw, refine, regenerate, enhance, beautify or alter ANY facial feature. Eyebrows: keep identical shape, identical thickness, identical color, do not darken, do not thicken, do not reshape. Eyes: keep BOTH eyes the EXACT same color and shape as in the original — no color change, no graying, no bluing, no heterochromia, no resizing, no reshape. Nose, lips, jawline, chin, cheekbones, ears, skin tone, skin texture, freckles, moles, age and expression: 100% identical to original. The face is OFF-LIMITS. No glow, no beauty filter, no skin smoothing, no HDR. Preserve EXACT same framing, composition, zoom and crop — do not zoom in, do not recrop, keep the same body and shoulders visible. Same lighting, exposure, contrast, background, clothes."

Para CORTE 2 (CREW CUT TEXTURIZADO) usa esta plantilla:
"Strict hair-only edit. The person in this photo has a COMPLETELY CLEAN-SHAVEN smooth face with NO facial hair at all — keep it EXACTLY like that. Replace ONLY the hair on top of the head with a [DETALLE — describe specifically: short textured crew cut, hair length 1-2cm on top with natural messy texture, slightly pushed forward in a SUBTLE way, sides with mid fade]. The top must be VERY SHORT (1-2cm max), NOT a fringe covering the forehead, NOT a bowl cut, NOT a mushroom shape. Forehead visible. Keep EXACT same hair color. ABSOLUTELY DO NOT add any beard, mustache, goatee, stubble, sideburns or facial shadow — the chin, cheeks, jawline and upper lip must remain perfectly smooth and bare, exactly like in the original photo. CRITICAL: DO NOT TOUCH ANY PART OF THE FACE. The face must be copied PIXEL BY PIXEL from the original photo without any modification whatsoever. Do not retouch, redraw, refine, regenerate, enhance, beautify or alter ANY facial feature. Eyebrows: keep identical shape, identical thickness, identical color, do not darken, do not thicken, do not reshape. Eyes: keep BOTH eyes the EXACT same color and shape as in the original — no color change, no graying, no bluing, no heterochromia, no resizing, no reshape. Nose, lips, jawline, chin, cheekbones, ears, skin tone, skin texture, freckles, moles, age and expression: 100% identical to original. The face is OFF-LIMITS. No glow, no beauty filter, no skin smoothing, no HDR. Preserve EXACT same framing, composition, zoom and crop — do not zoom in, do not recrop, keep the same body and shoulders visible. Same lighting, exposure, contrast, background, clothes."

Para CORTE 3 (SIDE PART CLÁSICO ELEGANTE) usa esta plantilla:
"Strict hair-only edit. The person in this photo has a COMPLETELY CLEAN-SHAVEN smooth face with NO facial hair at all — keep it EXACTLY like that. Replace ONLY the hair on top of the head with a [DETALLE — describe specifically: classic modern side part haircut, hair length 4-5cm on top combed cleanly to one side with a defined side parting line, polished elegant look, sides with mid fade]. Style refined like a well-dressed young professional. NO huge volume, NO pompadour, NO Elvis-style quiff, no dramatic puff. Forehead clearly visible. Keep EXACT same hair color. ABSOLUTELY DO NOT add any beard, mustache, goatee, stubble, sideburns or facial shadow — the chin, cheeks, jawline and upper lip must remain perfectly smooth and bare, exactly like in the original photo. CRITICAL: DO NOT TOUCH ANY PART OF THE FACE. The face must be copied PIXEL BY PIXEL from the original photo without any modification whatsoever. Do not retouch, redraw, refine, regenerate, enhance, beautify or alter ANY facial feature. Eyebrows: keep identical shape, identical thickness, identical color, do not darken, do not thicken, do not reshape. Eyes: keep BOTH eyes the EXACT same color and shape as in the original — no color change, no graying, no bluing, no heterochromia, no resizing, no reshape. Nose, lips, jawline, chin, cheekbones, ears, skin tone, skin texture, freckles, moles, age and expression: 100% identical to original. The face is OFF-LIMITS. No glow, no beauty filter, no skin smoothing, no HDR. Preserve EXACT same framing, composition, zoom and crop — do not zoom in, do not recrop, keep the same body and shoulders visible. Same lighting, exposure, contrast, background, clothes."

IMPORTANTE: 1 = rapado uniforme deportivo, 2 = un poco más largo con textura casual, 3 = más elegante con raya lateral marcada estilo formal. Los 3 achievables en barbería normal.`
...
.corte-imagen { width: 100%; height: 100%; object-fit: cover; object-position: 50% 20%; }
